...
class TreeNode:
    ...
    def insert(self, verx: VectorNode):
    ...
    def _insert_recursive(self, verx: VectorNode):
...
def tree_search_algorithm(f, axis, n_it=10, n_p=5, n_limit=0):
    ...
    return local_min_node


min_node = tree_search_algorithm(
    lambda x: sum(x) ** 2, [(0, 3) for _ in range(2)], 10, 5, 2
)
